...
<div class="row">
    <div class="columnLeft">
        <h2>ANGULAR</h2>
        <blockquote>
             <h3>ANGULAR FULL APPLICATION</h3>
             <div>
                    <blockquote>
                        <ul>
                            <li><b>Description: </b>Security Service Maintenance</li>
                            <li><a href="https://github.com/donhenton/sec-maint">GitHub Source</a></li>
                            <li><a href="https://donhenton.github.io/sec-maint/public_html/">Demonstration Site</a></li>
                     
                        </ul>
                    </blockquote>

             <h3>ANGULAR SNIPPETS</h3>
                    <blockquote>
                        <ul>
                            <li><b>Description: </b>Angular 5 Samples and Demos</li>
                            <li><a href="https://github.com/donhenton/angular4-snippets">GitHub Source</a></li>
                            <li><a href="https://donhenton.github.io/angular4-snippets/public_html">Demonstration Site</a></li>
                        </ul>
                    </blockquote>
        </blockquote>
        <h2>SPRING BOOT</h2>
    ...
    <div class="columnRight">
            ...
            <blockquote>
                     ...
                     <h3>LIST DEMO (ES6)</h3>
                      ...
                      <blockquote>
                        <ul>
                            <li><b>Description: </b>Responsive Web Site Using React</li>
                            <li><a href="https://github.com/donhenton/marvel-server">GitHub Source</a></li>
                            <li><a href="http://marvel-server.herokuapp.com/">Demonstration Site</a></li>
                        </ul>
                       </blockquote>
                      ...
                      <blockquote>
                        <ul>
                            <li><b>Description: </b>D3 and React</li>
                            <li><a href="https://github.com/donhenton/graph-components">GitHub Source</a></li>
                            <li><a href="https://donhenton.github.io/graph-components/public_html">Demonstration Site</a></li>
                        </ul>
                       </blockquote>
    ...
    <div class="columnRight">
            ...
            <blockquote>
                     ...
                     <h3>RESPONSIVE CSS</h3>
                      <blockquote>
                        <ul>
                            <li><b>Description: </b>Responsive Design Experiments</li>
                            <li><a href="https://github.com/donhenton/master-responsive-code">GitHub Source</a> </li>
                            <li><a href="https://donhenton.github.io/master-responsive-code/public_html/">Demonstration Site</a></li>
                        </ul>
                       </blockquote>
                      ...
                      <blockquote>
                        <ul>
                            <li><b>Description: </b>Parse Logic Strings And Return Abstract Syntax Trees</li>
                            <li><a href="https://github.com/donhenton/js-parser">GitHub Source</a></li>
                            <li><a href="https://donhenton.github.io/js-parser/public_html/">Demonstration Site</a></li>
                        </ul>
                       </blockquote>
