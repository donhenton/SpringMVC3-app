...
<head>
  ...
  <link href='<%= swaggerPath %>css/screen.css' media='print' rel='stylesheet' type='text/css'/>
  <script type="text/javascript" src="<%= swaggerPath %>lib/shred.bundle.js"></script>
  ...
  <script src='<%= swaggerPath %>lib/handlebars-1.0.0.js' type='text/javascript'></script>
  ...
  <script src='<%= swaggerPath %>lib/swagger.js' type='text/javascript'></script>
  ...
  <div class="swagger-ui-wrap">
    ...
    <form id='api_selector'>
      <div class='input icon-btn'>
        <img id="show-pet-store-icon" src="<%= swaggerPath %>images/pet_store_api.png" title="Show Swagger Petstore Example Apis">
      </div>
      <div class='input icon-btn'>
        <img id="show-wordnik-dev-icon" src="<%= swaggerPath %>images/wordnik_api.png" title="Show Wordnik Developer Apis">
      </div>
